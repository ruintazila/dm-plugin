...
public class PluginsProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":dm-plugin"
     */
    public DmPluginProjectDependency getDmPlugin() { return new DmPluginProjectDependency(getFactory(), create(":dm-plugin")); }
